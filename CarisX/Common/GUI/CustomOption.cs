...
namespace Oelco.Common.GUI
{
    ...
    /// </summary>
    public class CustomUOptionSet : UltraOptionSet
    {
        #region [インスタンス変数定義]
        ...
        /// コンストラクタ
        /// </summary>
        public CustomUOptionSet()
        {
            this.HandleCreated += new EventHandler( CustomOption_HandleCreated );
        ...
        void CustomOption_HandleCreated( object sender, EventArgs e )
        {
            // GlyphInfoの初期化(既定)
