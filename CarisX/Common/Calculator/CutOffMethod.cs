...
namespace Oelco.Common.Calculator
{
    ...
    /// CutOff計算処理クラスです。
    /// </remarks>
    public class CutOffMethod : ICalcMethod
    {
        #region [インスタンス変数定義]
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="pc">陽性閾値(カウント)</param>
        /// <param name="nc">陰性閾値(カウント)</param>
        ...
        public CutOffMethod( Double pc, Double nc, Double coef_a, Double coef_b, Double coef_c, Double coef_d, Double coef_e )
        {
            this.SetPCNC( pc, nc );
