...
namespace Oelco.Common.Comm
{
    ...
    /// 通信データの送信機能を提供します。
    /// </remarks>
    public class DataSendThread : ThreadBase
    {
        #region [クラス変数定義]
        ...
        /// 通信マネージャ
        /// </summary>
        private CommProtocolManager protocolManager = null;
        ...
        /// 通信マネージャの設定を行います
        /// </remarks>
        public void SetProtocolManager( CommProtocolManager manager )
        {
...
//            while ( waitIndex == WaitHandle.WaitTimeout || )
            while ( waitIndex == 0 )
            {
                //if ( waitIndex == 0 )
                //{
