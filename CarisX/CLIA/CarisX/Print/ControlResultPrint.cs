...
namespace Oelco.CarisX.Print
{
    ...
    /// </summary>
    /// <remarks>
    /// 精度管理検体測定結果印刷用にデータを持たせておくクラスです。
    /// </remarks>
    class ControlResultReportData
    {
        /// <summary>
        /// シーケンスNo.
        /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// 精度管理検体測定結果画面に表示したデータを印刷します。
    /// </remarks>
    public class ControlResultPrint : PrintBase
    {
        ...
        /// コンストラクタ
        /// </summary>
        public ControlResultPrint()
        {
            //this.Initialize();
            rptType = Type.GetType( String.Format( "Oelco.CarisX.Print.ControlResultReport_{0}", SubFunction.GetRegionName( CarisXConst.SupportRegion ) ) );
            if ( rptType != null )
            {
        ...
        {
            // 型が ControlResultReportData かどうかをチェック
            if ( !( dataSource is List<ControlResultReportData> ) )
            {
                return false;
            }
        ...
        {
            //this.document = new ControlResultReport();

            //ControlResultReport rpt = (ControlResultReport)this.document;

            //Type type = Type.GetType( String.Format( "Oelco.CarisX.Print.ControlResultReport_{0}", SubFunction.GetRegionName( CarisXConst.SupportRegion ) ) );
            ...
            {                           
                ...
                reportTitle.Text = Resources.STRING_CONTROLRESULT_PRINT_000;
                seqNo.Text = Resources.STRING_CONTROLRESULT_PRINT_001;
                rackID.Text = Resources.STRING_CONTROLRESULT_PRINT_002;
                ctrlName.Text = Resources.STRING_CONTROLRESULT_PRINT_003;
                ctrlLot.Text = Resources.STRING_CONTROLRESULT_PRINT_004;
                comment.Text = Resources.STRING_CONTROLRESULT_PRINT_005;
                analytes.Text = Resources.STRING_CONTROLRESULT_PRINT_006;
                count.Text = Resources.STRING_CONTROLRESULT_PRINT_007;
                countAvg.Text = Resources.STRING_CONTROLRESULT_PRINT_008;
                conc.Text = Resources.STRING_CONTROLRESULT_PRINT_009;
                concAvg.Text = Resources.STRING_CONTROLRESULT_PRINT_010;
                multiMeas.Text = Resources.STRING_CONTROLRESULT_PRINT_011;
                // remark.Text = Resources.STRING_CONTROLRESULT_PRINT_012;
                ReagentLotNo.Text = Resources.STRING_CONTROLRESULT_PRINT_013;
                // PreTriggerLotNo.Text = Resources.STRING_CONTROLRESULT_PRINT_014;
                // TriggerLotNo.Text = Resources.STRING_CONTROLRESULT_PRINT_015;
                measTime.Text = Resources.STRING_CONTROLRESULT_PRINT_016;
            }                      
        }
        ...
        public Int32 GetTotalPageCount( List<Tuple<Int32, Int32, Int32>> indUniqRepList )
        {
            ...
            List<ControlResultReportData> dataSource = new List<ControlResultReportData>();

            foreach ( var data in indUniqRepList )
            {
                var dummy = new ControlResultReportData();
        ...
        public Int32 GetTotalPageCount( Int32 dtCount )
        {
            ...
            {
                dataSource.Add( new ControlResultReportData() );
            }
            return base.GetTotalPageCount( dataSource );
        }
