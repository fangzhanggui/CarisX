...
namespace Oelco.CarisX.Parameter.MaintenanceJournalCodeData
{
    ...
    public class MaintenanceJournalCodeDataManager : ISavePath
    {
        ...
        public MaintenanceJournalCodeData GetCodeData(String maintenanceJournalCode, String maintenanceJournalCodeArgument, String maintenanceJournalKind , String maintenanceJournalUnit)
        {
            ...
            var searchedGroup = (from v in this.codeDataList  //maintenanceJournalList
                                  where v.Code == maintenanceJournalCode & v.Kind == maintenanceJournalKind & v.Unit == maintenanceJournalUnit
