...
{
    /// <summary>
    /// 使用可能な試薬を保持しているモジュールの確認ダイアログクラス
    /// </summary>
    public partial class DlgCheckHoldsAvailableReag : DlgCarisXBaseSys
    {
        ...
        /// コンストラクタ
        /// </summary>
        public DlgCheckHoldsAvailableReag()
        {
            InitializeComponent();
            ...
            case Status.SystemStatusKind.ToAssay:
            case Status.SystemStatusKind.StopAssay:
